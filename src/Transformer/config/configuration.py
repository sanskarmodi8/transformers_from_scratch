...
class ConfigurationManager:
    ...
    def get_model_training_config(self) -> ModelTrainingConfig:
        ...
        return ModelTrainingConfig(
            ...
            lr_factor=self.params.lr_factor,
            clip_grad=self.params.clip_grad,
            src_tokens_per_batch=self.params.src_tokens_per_batch,
            tgt_tokens_per_batch=self.params.tgt_tokens_per_batch,
            total_steps=self.params.total_steps,
            adam_beta1=self.params.adam_beta1,
            adam_beta2=self.params.adam_beta2,
            adam_epsilon=self.params.adam_epsilon,
            label_smoothing=self.params.label_smoothing,
            last_n_checkpoints_to_avg=self.params.last_n_checkpoints_to_avg,
            checkpoint_interval_minutes=self.params.checkpoint_interval_minutes,
